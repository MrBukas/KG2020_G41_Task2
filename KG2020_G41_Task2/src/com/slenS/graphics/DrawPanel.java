package com.Bukas.graphics;


import com.Bukas.factories.LDFactory;
import com.Bukas.factories.LineDrawerFactory;
import com.Bukas.line_drawers.LineDrawer;
import com.Bukas.utils.DrawUtils;
...
public class DrawPanel extends JPanel implements MouseMotionListener, MouseListener {
    ...
    private void drawAll(LineDrawer ld) {
        DrawUtils.drawSnowflake(ld, getWidth() / 2, getHeight() / 2, 150, 64);
